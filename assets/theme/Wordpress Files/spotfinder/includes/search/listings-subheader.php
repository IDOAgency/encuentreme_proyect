            	...
            	<form id="listing-sort-form" action="<?php echo home_url(); ?>" method="get">
                    ...
                    <select name="listing-sort">
						...
						?>
							...
							<option value="<?php echo _sf_get_list_sort_url($slug.'_low'); ?>"<?php if(_sf_is_sort_by($slug.'_low')) { echo ' selected="selected"'; } ?>><?php the_title(); ?> <?php _e('(Lowest to Highest)', 'btoa'); ?></option>
							<option value="<?php echo _sf_get_list_sort_url($slug.'_high'); ?>"<?php if(_sf_is_sort_by($slug.'_high')) { echo ' selected="selected"'; } ?>><?php the_title(); ?> <?php _e('(Highest to Lowest)', 'btoa'); ?></option>
