...
?>
	...
	<ul id="social">
    	...
    	<?php if(ddp('social_instagram') != '') : //// FACEBOOK ?><li><a href="<?php echo ddp('social_instagram') ?>" class="social-instagram" title="<?php echo get_bloginfo('name'); ?> Instagram"><i class="icon-instagram"></i></a></li><?php endif; ?>
