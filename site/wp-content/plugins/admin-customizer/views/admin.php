<div class="wrap">
    <h2><?php _e('Admin Customizer Settings', $this->plugin_slug); ?></h2>
</div>
<div id="admin-customizer-formwrapper">
    <form name="form1" method="post" action="options.php">
        <?php settings_fields('admin-customizer-options-group'); ?>
        <div id="admin-customizer-tab-container" class="tab-container">
            <ul class='etabs'>
                <li class='tab'><a href="#adnstab-theme">
                        <?php _e("Theme", $this->plugin_slug); ?>
                    </a></li>
                <li class='tab'><a href="#adnstab-header">
                        <?php _e("Header", $this->plugin_slug); ?>
                    </a></li>
                <li class='tab'><a href="#adnstab-dashboard">
                        <?php _e("Dashboard", $this->plugin_slug); ?>
                    </a></li>
                <li class='tab'><a href="#adnstab-footer">
                        <?php _e("Footer", $this->plugin_slug); ?>
                    </a></li>
                <li class='tab'><a href="#adnstab-login">
                        <?php _e("Login", $this->plugin_slug); ?>
                    </a></li>
                <li class='tab'><a href="#adnstab-other">
                        <?php _e("Other", $this->plugin_slug); ?>
                    </a></li>
            </ul>
            <div class='panel-container'>
                ...
                <div id="adnstab-theme">
                    <h2>
                        <?php _e("Theme settings", $this->plugin_slug); ?>
                    </h2>
                ...
                <div id="adnstab-header">
                    <h2>
                        <?php _e("Header Section", $this->plugin_slug); ?>
                    </h2>
                    <table class="form-table">
                        <tbody>
                            <tr valign="top">
                ...
                <div id="adnstab-footer">
                    <h2>
                        <?php _e("Footer Section", $this->plugin_slug); ?>
                    </h2>
                    <table class="form-table">
                        <tbody>
                            <tr valign="top">
                ...
                <div id="adnstab-login">
                    <h2>
                        <?php _e("Login Page", $this->plugin_slug); ?>
                    </h2>
                    <table class="form-table">
                        <tbody>
                            <tr valign="top">
                ...
                <div id="adnstab-other">
                    <h2>
                        <?php _e("Other settings", $this->plugin_slug); ?>
                    </h2>
                    <table class="form-table">
                        <tbody>
                            <tr valign="top">
        ...
        <?php submit_button(__('Save Changes', $this->plugin_slug)); ?>
