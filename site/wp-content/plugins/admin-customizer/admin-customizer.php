...
class AdminCustomizer
{
    ...
    public function register_admin_scripts($hook)
    {
        ...
        wp_enqueue_script($this->plugin_slug.'-cookies-script',
            plugins_url($this->plugin_slug .'/js/jquery.cookie.js'),
                array('jquery', 'jquery-ui-tabs' ));
        wp_enqueue_script($this->plugin_slug.'-admin-script', plugins_url($this->plugin_slug.'/js/admin.js'), array('jquery', 'jquery-ui-tabs','wp-color-picker'));
    }
    ...
    private function _customizerActions()
    {
        ...
        if ($this->options['adns_hide_update_nagging_bar'] == 1)
        {
            ...
            //add_action('admin_head', array($this, 'hide_update_nagging_bar'));
        }
        //replace howdy
